...
// These power the timeline components. Each array is empty (or
// minimally filled) by default — add real entries only.
// The Timeline component automatically hides a track if its
